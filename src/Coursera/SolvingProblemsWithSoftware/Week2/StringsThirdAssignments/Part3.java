...
import Coursera.SolvingProblemsWithSoftware.Week2.StringsThirdAssignments.*;
...
public class Part3 {
    ...
    private void processGenes(StorageResource sr) {
        ...
        for (String gene : sr.data()) {
            ...
            if (currentLength > 9) {
                System.out.println("Longer than 9 characters: " + gene);
                lengthCount++;
            }
        ...
        System.out.println("Total gene longer than 9 characters: " + lengthCount);
    ...
    public void testProcessGenes() {
        ...
        String dna = "ATGxxxxxxTAAxxxxxxATGxxxxxxxxxxxxTAGxxATGxxxxxxxxxxxxTGA";
